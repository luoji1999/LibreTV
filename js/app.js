// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["qiqi","newsource1","newsource2","newsource3","newsource4"]'); // 默认选中自定义资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中自定义资源
        selectedAPIs = ["qiqi", "newsource1", "newsource2", "newsource3", "newsource4"];
